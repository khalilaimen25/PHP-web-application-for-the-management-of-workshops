...
<div id="body1">
  ...
  <table style="width:470px;">
    ...
    <tr>
      <td></td><td align=center><button class="ac" type="button" name="button" onclick="window.location.href='addpage.php'">Acceuil</button><button style="margin-right: 30px;"type="submit" name="send" >Valider</buttom></td>
    </tr>
  </table>
	<?if (isset($x))
	{echo "<p class='at'>$x</p>";}?>
