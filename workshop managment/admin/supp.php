...
$res=$DB->query('SELECT * FROM etudiant');
...
<div class="tab">
<p>Suppresion etudiant</p>
<center>
  <form method="post" action="suppetud.php" onsubmit="return confirm('Are you sure you want to delete? ')">
...
<tr align=center>
  ...
  <th>email</th><th>telef</th><th>classement</th><th>id_atelier</th><th>nb_abs</th>
</tr>
...
<td><? echo $data['tel']; ?></td>
<td><? echo $data['classement']; ?></td>
<td><? echo $data['id_atelier']; ?></td>
<td><? echo $data['nb_abs']; ?></td>
</tr>
<?
}
