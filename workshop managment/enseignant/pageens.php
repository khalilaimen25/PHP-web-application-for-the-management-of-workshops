...
$req=$DB->query("select * from enseignant where user='".$idu."' and password='".$psw."'");
    ...
    <div id="body1">
      ...
      <div id="menu" >
            <ul style="padding-left:5%;">
              <li style="margin-left:220px;"><a href="note.php">Consulter notes</a></li>
      ...
      <p class="dat">Le :  <?echo date("d.m.Y");?></p>
       ...
       <center>
        <table class="infos">
          ...
          <tr>
            <th>Classement :</th><td><?echo $grade?></td>
          </tr>
          <tr>
